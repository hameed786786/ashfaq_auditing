...
const HeroSection: React.FC = () => {
    return (
        ...
        >
            ...
            <div className="relative w-full mt-[20px] sm:mt-[60px] md:mt-[70px] lg:mt-[70px] flex justify-end px-[15px] sm:px-0 ">
                <Image
                    src="/assets/hero-architecture.png"
                    alt="Modern glass skyscraper architecture"
                    width={1320}
                    height={700}
                    className="w-full sm:w-full md:w-full lg:w-[1320px] h-[300px] sm:h-[400px] md:h-[550px] lg:h-[700px] object-cover object-bottom rounded-xl md:rounded-none"
                />
            </div>
        </div>
    );
