...
export default function AboutSection() {
    ...
    <section className="w-full bg-white py-12 sm:py-16 md:py-20 lg:py-[60px] overflow-hidden">
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 md:px-8 lg:px-0 ">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[58%_42%] gap-4 md:gap-6 lg:gap-0 w-full flex items-center">
          ...
          {/* Building Image */}
          <div className="relative h-[200px] sm:h-[250px] md:h-[300px] lg:h-[378px] overflow-hidden w-full lg:w-[834px]">
            <Image
          ...
          {/* About Us Title */}
          <div className="border-t border-b border-[#E5E5E5] flex items-center justify-start h-[180px] sm:h-[20px] md:h-[160px] lg:h-[250px] w-full lg:w-[834px]">
            <h2
        ...
        {/* Bottom Row */}
        <div className="mt-6 sm:mt-8 md:mt-12 lg:mt-[80px] lg:ml-[60px] w-full grid grid-cols-1 lg:grid-cols-[24%_28%_48%] gap-6 md:gap-8 lg:gap-[20px] items-center">
  ...
  <div className="flex flex-col gap-[40px] sm:gap-[50px] lg:gap-[60px]">
    ...
    <div className="flex flex-col gap-2 sm:gap-3 lg:gap-4">
      {/* Icon & Title Row */}
      <div className="flex items-center gap-2 sm:gap-3 md:gap-4 lg:gap-[16px]">
  ...
  <div className="flex flex-col justify-center">
    ...
    <button
      className="mt-4 sm:mt-5 md:mt-6 lg:mt-8 w-[130px] sm:w-[140px] md:w-[150px] lg:w-[153px] h-[36px] md:h-[38px] lg:h-[38.25px] flex items-center justify-center rounded-full bg-black text-white text-[10px] sm:text-[11px] md:text-[12px] lg:text-[13.5px] font-medium transition-all duration-300 hover:scale-[1.03]"
      style={{
        fontFamily: "var(--font-manrope), sans-serif",
        fontWeight: 400
      }}
